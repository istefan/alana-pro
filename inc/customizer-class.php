...
/**
 * Define alana settings file
 */
function alana_customizer_register( $wp_customize ) {
...
add_action( 'customize_register', 'alana_customizer_register' );


/**
 * alana Customizer custom control classes
 */
